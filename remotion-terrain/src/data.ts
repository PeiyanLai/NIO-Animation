...
export const ES9_SPEC = {
  ...
  tireODMM: 832,          // 275/45R23 外径 ≈ 584 + 2×124
  rimToTireRatio: 0.702,  // 584/832 —— 矢量轮必须遵守：轮辋半径 = 胎圈半径 × 0.70
} as const;

export const SPEED = 130; // 地面滚动 px/s
export const WHEEL_R = 44; // 前轮滚动半径（舞台px）= 照片实测胎圈 80px × 0.55
...
export const CAR_BODY =
  'M40,240L46,220L60,212L80,206L100,201L120,196L150,190L180,185L210,182L240,179L270,176L292,172L300,160L306,150L314,142L326,132L340,122L356,111L372,101L386,92L398,83L408,76L418,72L432,70L450,69L470,68L520,67L570,66L620,66L670,67L720,69L770,71L786,72L790,66L800,63L815,62L826,64L832,73L840,76L856,79L875,81L895,83L905,85L912,120L922,133L934,147L945,166L954,180L960,196L962,215L959,250L953,285L946,308L937,320L925,327L905,334L880,341L860,344L700,346L350,344L200,338L146,332L120,326L100,320L80,315L60,308L46,300L40,288Z';
